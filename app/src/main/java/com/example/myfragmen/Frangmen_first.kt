...
class Frangmen_first : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_frangmen_first, container, false)
    ...
    companion object {
        fun newInstance(): Frangmen_first {
            return Frangmen_first()
        }
    }
}
